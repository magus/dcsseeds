...
const Versions = {
  // e.g. https://github.com/crawl/crawl/blob/0.28.0/crawl-ref/source/dat/species
  [Keys.v280]: '0.28.0',
  [Keys.v271]: '0.27.1',
  [Keys.v270]: '0.27.0',
...
const VersionRecommendedBackgrounds = buildConvertedLookup({
  // e.g. https://github.com/crawl/crawl/tree/0.28.0/crawl-ref/source/dat/species
  [Versions.v280]: {
...
const VersionRecommendedSpecies = buildConvertedLookup({
  // e.g. https://github.com/crawl/crawl/blob/0.28.0/crawl-ref/source/job-data.h
  [Versions.v280]: {
...
// e.g. https://github.com/crawl/crawl/blob/0.28.0/crawl-ref/source/ng-restr.cc
